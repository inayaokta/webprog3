        ...
        <li class="nav-item active">
            ...
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('buku'); ?>">
                    <i class="fa fa-fw fa book"></i>
                    <span>Data Buku (<?=$this->db->query("select*from buku")->num_rows();?> Data)</span></a></span></a>
            </li>
            <li class="nav-item">
        ...
        <li class="nav-item active">
            ...
            <li class="nav-item">
                ...
                <i class="fa fa-fw fa-list"></i>
                    <span>Data Booking (<?=$this->db->query("select*from booking")->num_rows();?> Data)</span></a></span></a>
            </li>
